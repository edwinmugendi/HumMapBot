    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group"> 
                ...
                <button type="button" class="deleteRow btn btn-default" data-container="body" data-toggle="tooltip" data-placement="bottom" title="<?php echo '<?php echo \Lang::get($view_data[\'package\'] . \'::\' . $view_data[\'controller\'] . \'.view.actions.delete.delete\');?>' ?>"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>
