    ...
    <div class="row commonMarginTop5">
        <div class="col-md-12">
            <div class="btn-group"> 
                ...
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#idImportModal" data-container="body" data-toggle="tooltip" data-placement="bottom" title="<?php echo '<?php echo \Lang::get(\'common.importView.import\'); ?>' ?>"><i class="fa fa-upload fa-2x" aria-hidden="true"></i></button>
            </div>
        </div>
    </div>
    <?php echo '<?php endif; ?>'; ?>
