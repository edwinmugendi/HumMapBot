            ...
            <table id="idListTable" class="table table-bordered table-condensed table-striped table-hover"> 
                <thead> 
                    <tr>
                        ...
                        $is_ordered = false;
                        ?>
                        <?php if (array_key_exists('sort', $view_data['input']) && $view_data['input']['sort'] == 'food_chicken'): ?>
                             <?php $is_ordered = true;?>
                                <?php if (array_key_exists('order', $view_data['input']) && $view_data['input']['order'] == 'desc'): ?>
                                <?php
                                $order = 'asc';
                        ...
                        <?php if ($view_data['paginationAppends']): ?>
                            <?php $url = http_build_query($view_data['paginationAppends']) . '&order=' . $order . '&sort=food_chicken'; ?>
                        <?php else: ?>
                            <?php $url = 'order=' . $order . '&sort=food_chicken';?>
                        <?php endif;?>                                <th>   
                                    <a href="<?php echo \Route(camel_case($view_data['package'] . '_list_' . $view_data['controller'])) . '?' . $url ?>">
                                        <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.view.field.food_chicken'); ?>                                        <?php if ($is_ordered): ?>                                        <span class="<?php echo ($order == 'asc') ? 'dropdown':'dropup';?>"><span class="caret"></span></span>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <?php else: ?>                                <th>
                                    <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.view.field.food_chicken'); ?>                                </th>
                                <?php endif; ?>                                                                                                                <?php if (!array_key_exists('export', $view_data)): ?>                                <?php
                        $order = 'asc';
                        $is_ordered = false;
                        ?>
                        <?php if (array_key_exists('sort', $view_data['input']) && $view_data['input']['sort'] == 'food_fish'): ?>
                             <?php $is_ordered = true;?>
                                <?php if (array_key_exists('order', $view_data['input']) && $view_data['input']['order'] == 'desc'): ?>
                                <?php
                                $order = 'asc';
                        ...
                        <?php if ($view_data['paginationAppends']): ?>
                            <?php $url = http_build_query($view_data['paginationAppends']) . '&order=' . $order . '&sort=food_fish'; ?>
                        <?php else: ?>
                            <?php $url = 'order=' . $order . '&sort=food_fish';?>
                        <?php endif;?>                                <th>   
                                    <a href="<?php echo \Route(camel_case($view_data['package'] . '_list_' . $view_data['controller'])) . '?' . $url ?>">
                                        <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.view.field.food_fish'); ?>                                        <?php if ($is_ordered): ?>                                        <span class="<?php echo ($order == 'asc') ? 'dropdown':'dropup';?>"><span class="caret"></span></span>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <?php else: ?>                                <th>
                                    <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.view.field.food_fish'); ?>                                </th>
                                <?php endif; ?>                                                                                                                <?php if (!array_key_exists('export', $view_data)): ?>                                <?php
                        $order = 'asc';
                        $is_ordered = false;
                        ?>
                    ...
                    <?php if (!array_key_exists('export', $view_data)): ?>                    <tr>
                        ...
                        <td></td>
                                                                            ...
                                                                            <?php echo \Form::text('height', isset($view_data['input']['height']) ? $view_data['input']['height'] : '', array('class' => 'form-control')); ?>                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                            <?php echo \Form::compositeSelect('gender', $view_data['dataSource']['gender'], isset($view_data['input']['gender']) ? $view_data['input']['gender'] : '', array('class' => 'form-control')); ?>                                                                    </td>
                                                                            ...
                                                                            <?php echo \Form::text('lng', isset($view_data['input']['lng']) ? $view_data['input']['lng'] : '', array('class' => 'form-control')); ?>                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                            <?php echo \Form::compositeSelect('food_chicken', $view_data['dataSource']['food_chicken'], isset($view_data['input']['food_chicken']) ? $view_data['input']['food_chicken'] : '', array('class' => 'form-control')); ?>                                                                    </td>
                                
                                                                                    <td>
                                                                            <?php echo \Form::compositeSelect('food_fish', $view_data['dataSource']['food_fish'], isset($view_data['input']['food_fish']) ? $view_data['input']['food_fish'] : '', array('class' => 'form-control')); ?>                                                                    </td>
