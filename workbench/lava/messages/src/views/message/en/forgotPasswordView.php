...
<p class="lead" style="color: #222222; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; text-align: left; line-height: 25px; font-size: 16px; margin: 0 0 25px; padding: 0;" align="left">
    We received a request to reset the password for your <?php echo $view_data['productName']; ?> account for email address <?php echo $view_data['forgot_email']; ?>
</p>
<p style="color: #222222; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; text-align: left; line-height: 19px; font-size: 14px; margin: 25px 0 10px; padding: 0;" align="left">To reset your password, please click on the link below (or copy and paste the link (URL) onto your browser):</p>
