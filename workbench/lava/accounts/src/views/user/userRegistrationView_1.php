                        ...
                        <div class="shadowPortlet commonBorderRadius commonBorderColor row-fluid">
                            ...
                            <div class="shadowPortletContainer commonBorderRadius commonBorderColor">
                                ...
                                <div class="row commonClearBoth commonOverflowHidden">
                                    ...
                                    <div class="col-md-12 commonMarginTop10">
                                        <?php echo \InputGroup::withContents(\Form::text('town', '', array('placeholder' => \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.field.town'), 'class' => 'validate[required,, custom[town]')))->prepend('<i class = "icon-data-location"></i>')->append('<i class = "glyphicon glyphicon-star commonColorRed" title = "' . \Lang::get('common.required') . '"></i>'); ?>
