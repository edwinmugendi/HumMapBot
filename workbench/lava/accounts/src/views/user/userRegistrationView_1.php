<div id="userRegistration" class="commonContainer commonMaxWidth commonOverflowHidden">
    <div class="row">
        <div class="col-md-5 col-md-offset-3 userRegistrationForm" >
            <?php if ($view_data['registrationType'] == 'activate'): ?>
                <?php if (\Session::has('activateCode')): ?>
                    <p class="commonColor"><?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.activate.statusCode.' . \Session::get('activateCode')); ?></p>
                <?php endif; ?>
                    ...
                    <div class="shadowPortletContainer commonBorderRadius commonBorderColor">
                        ...
                        <div>
                            ...
                            <div class="commonMarginTop5">
                                <?php echo Form::submit($login, array('class' => 'btn-processing btn-primary btn-large', 'data-processing' => \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.login.processing'))); ?>
                            </div>
                    ...
                    <div class="shadowPortletContainer commonBorderRadius commonBorderColor">
                        ...
                        <div class="row-fluid commonClearBoth commonOverflowHidden">
                            <div class="span6 commonFloatLeft">
                                <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.field.firstName'); ?>:<br/>
                            ...
                            <div class="span6 secondNameDiv">
                                <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.field.lastName'); ?>:<br/>
                        ...
                        <div>
                            <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.field.email'); ?>:<br/>
                        ...
                        <div>
                            <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.field.password'); ?>:<br/>
                        ...
                        <div>
                            <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.field.confirm_password'); ?>:<br/>
                        ...
                        <div>
                            <?php echo Form::submit(\Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.submit'), array('class' => 'btn-processing btn-primary btn-large', 'data-processing' => \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.register.processing'))); ?>
                        </div>
                        <?php Form::close(); ?>
                    </div>
                </div>
            ...
            <?php elseif ($view_data['registrationType'] == 'reset'): ?>
                ...
                <?php if ($resetStatusCode == 1): ?>
                    <h2><?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.reset.statusCode.1'); ?></h2>
                <?php endif; ?>
                <div class="shadowPortlet commonBorderRadius commonBorderColor row-fluid">
                    <!--S# shadow portlet heading div-->
                    <div class="shadowPortletHeading">
                    ...
                    <div class="shadowPortletContainer commonBorderRadius commonBorderColor">
                        <?php echo \Lang::get($view_data['package'] . '::' . $view_data['controller'] . '.' . $view_data['page'] . '.' . $view_data['view'] . '.form.reset.help', array('passwordMinCharacters' => \Config::get('product.passwordMinCharacters'))); ?>
                        ...
                        <?php echo Form::hidden('email', $view_data['input']['email']); ?>
                        <div>
