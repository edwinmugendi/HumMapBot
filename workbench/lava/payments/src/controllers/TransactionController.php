...
class TransactionController extends PaymentsBaseController {
    ...
    public function injectDataSources() {
        ...
        //Get this organization loan id
        $this->view_data['dataSource']['loan_id'] = $this->callController(\Util::buildNamespace('loans', 'loan', 1), 'getMerchantsHtmlSelect', array($this->merchant['id'], 'id', array('principal'), \Lang::get('common.select')));
