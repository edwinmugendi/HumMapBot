...
<div class="row">
    <div class="col-md-6">
        ...
        <?php echo '<?php echo \HTML::link(\URL::route(camel_case($view_data[\'package\'] . \'_post_\' . $view_data[\'controller\'])), \Lang::get($view_data[\'package\'] . \'::\' . $view_data[\'controller\'] . \'.view.link.add\'), array(\'class\' => \'btn btn-primary\')); ?>'; ?>
        <?php echo '<?php endif; ?>'; ?>
    </div>
