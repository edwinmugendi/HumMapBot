<tr class="singleRow" data-id="<?php echo '<?php echo $view_data[\'singleModel\'][\'id\']; ?>' ?>">
    ...
    <?php echo '<?php if (!array_key_exists(\'export\', $view_data)): ?>'; ?>
    <td>
        <a href="<?php echo '<?php echo \URL::route(camel_case($view_data[\'package\'] . \'_question_\' . $view_data[\'controller\']), array($view_data[\'singleModel\'][\'id\'])); ?>' ?>" title="<?php echo '<?php echo \Lang::get($view_data[\'package\'].\'::\'.$view_data[\'controller\'].\'.view.actions.edit_questions.edit_questions\'); ?>'; ?>" class="btn btn-warning btn-xs"><i class="fa fa-question"></i> <?php echo '<?php echo \Lang::get($view_data[\'package\'].\'::\'.$view_data[\'controller\'].\'.view.actions.edit_questions.edit_questions\'); ?>'; ?></a>
        ...
        <?php echo '<?php if ($view_data[\'singleModel\'][\'workflow\'] == \'published\'): ?>'; ?>
        <a href="#" data-id="<?php echo '<?php echo $view_data[\'singleModel\'][\'id\']; ?>' ?>"  data-ids="<?php echo '<?php echo $view_data[\'singleModel\'][\'id\']; ?>'; ?>" class="unpublishRow btn btn-primary btn-xs" title="<?php echo '<?php echo \Lang::get($view_data[\'package\'] . \'::\' . $view_data[\'controller\'] . \'.view.actions.unpublish.unpublish\'); ?>'; ?>"><i class="fa fa-thumbs-up"></i> <?php echo '<?php echo \Lang::get($view_data[\'package\'] . \'::\' . $view_data[\'controller\'] . \'.view.actions.unpublish.unpublish\'); ?>'; ?></a>
        <?php echo '<?php else: ?>'; ?>
        <a href="#" data-id="<?php echo '<?php echo $view_data[\'singleModel\'][\'id\']; ?>' ?>"  data-ids="<?php echo '<?php echo $view_data[\'singleModel\'][\'id\']; ?>'; ?>" class="publishRow btn btn-primary btn-xs" title="<?php echo '<?php echo \Lang::get($view_data[\'package\'] . \'::\' . $view_data[\'controller\'] . \'.view.actions.publish.publish\'); ?>'; ?>"><i class="fa fa-thumbs-up"></i> <?php echo '<?php echo \Lang::get($view_data[\'package\'] . \'::\' . $view_data[\'controller\'] . \'.view.actions.publish.publish\'); ?>'; ?></a>
        <?php echo '<?php endif; ?>'; ?>
